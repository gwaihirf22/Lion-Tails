export default function Footer() {
  return (
    <footer className="bg-card text-foreground mt-10 shadow-lg border-t border-border">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-heading font-bold drop-shadow-md">Lion Tails</h3>
            <p className="text-sm text-muted-foreground">Nurturing faith through stories</p>
          </div>
          <div className="flex space-x-4">
            <a href="#" className="hover:text-primary bg-card p-2 rounded-full hover:bg-card transition-all duration-300">
