  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          // text-base on a phone, NOT text-sm. iOS Safari zooms the page in whenever
          // a focused field computes under 16px, and never zooms back out -- which
          // is what made every dialog on an iPhone "start zoomed in" with its
          // fixed-position chrome panned off-screen. Unchanged from md: up.
