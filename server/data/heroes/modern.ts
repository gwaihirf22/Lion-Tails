...
export const modern: RawHero[] = [
  ...
  },
  {
    ...
    complications:
      "His arguments are sometimes accused of being neater than the questions deserve, and the Narnia books contain a portrayal of the Calormenes that reads badly today. Lewis was not writing systematic theology and said so; readers who take Mere Christianity as one are asking it for something it does not offer.",
    famousQuote:
