...
/**
 * The fifteen heroes the app shipped with, carried over intact.
 *
 * They now have stable slugs and an era, which is what the seed upserts
 * against. Their long biographies are still to be written -- these entries
 * keep the descriptions and contributions they already had rather than being
